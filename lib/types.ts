export type EventSettings = {
  ...
  inviteEyebrowLabel: string;
  namedInviteLabel: string;
  openInviteLabel: string;
  namedInviteDescription: string;
  openInviteDescription: string;
  generalInviteDescription: string;
  countdownTitle: string;
  venueSectionTitle: string;
  mapButtonLabel: string;
  musicPlayLabel: string;
  musicPauseLabel: string;
  guestCountConfirmedLabel: string;
  guestPendingDetail: string;
  guestDeclinedDetail: string;
  openingNote: string;
  eventDate: string;
  venueName: string;
  venueAddress: string;
